...
<?php
 ...
 <section class="home-description" id="description">
     <div class="description-about-dragon text-center text-white">
    <div class="description-about-content">
        <h1>DRAGON DE KOMODO</h1>
    </div>
</div>
     </section>
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        ...
        <p> Le dragon de Komodo (Varanus komodoensis), également appelé varan de Komodo ou dragon, <br>est un grand lézard endémique des îles Komodo en Indonésie. <br> Il se nourrit de différents animaux ainsi que de carcasses.</p>
    </div>
</div>
    <div class="row fram-space-before-medium fram-space-after-extra-large">
        <div class="col-lg-8">
   <img src="/images/jungle/komodo-dragon.jpg"  style="width: 700px; height: 500px; margin-top: 30px;"alt=""  >
        </div>
<div class="col-lg-4">
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Le dragon de Komodo se nourrit d’oiseaux, d’œufs, de reptiles (geckos, petits varans, …), d’invertébrés et de divers mammifères de taille variable (sangliers, cerfs, singes, chevaux, buffles, …).</p>
                      </li>
                    
                    <li><i class="fa-solid fa-earth-africa" style="width: 48px; height: 48px;"></i>
                    <div class="text-wrap">
                    <h6 class="category">Habitat</h6> 
                        <p class="value">Le dragon de Komodo vit dans les savanes et prairies tropicales ainsi que dans les forêts tropicales sèches.</p>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Le Dragon de komodo est en bonne santé.</p>
