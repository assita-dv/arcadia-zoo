...
<?php
 ...
 <section class="home-description" id="description">
     <div class="description-about-lion text-center text-white">
...
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        <div class="decrire">
        <h3>LION</h3>
        <p> Le lion (Panthera leo) est un grand félin que l’on trouve dans divers déserts et savanes d’Afrique <br> ainsi que dans quelques rares forêts tropicales sèches en Asie. Carnivore, <br> il se nourrit de toutes les proies qu’il trouve.</p>
    </div>
</div>
    <div class="row fram-space-before-medium fram-space-after-extra-large">
        <div class="col-lg-8">
   <img src="/savane/lion1.jpg"  style="width: 700px; height: 500px; margin-top: 30px;"alt=""  >
        </div>
<div class="col-lg-4">
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Animal imposant et assez rapide, le lion se nourrit de nombreux animaux qu’il trouve dans son habitat naturel. Il chasse ainsi principalement divers bovidés, comme les antilopes de toutes tailles (gnous, oryx, élands, …), ainsi que les zèbres, les buffles, les phacochères, les girafes et les lapins.</p>
                      </li>
                    
                    <li><i class="fa-solid fa-earth-africa" style="width: 48px; height: 48px;"></i>
                    <div class="text-wrap">
                    <h6 class="category">Habitat</h6> 
                        <p class="value">Le lion vit dans les savanes et les déserts en Afrique, dans les forêts tropicales sèches en Asie.</p>
