...
if (isset($_GET['service_id'])) {
    ...
    if ($sql->execute()) {
        ...
        header("location:services-db-emp.php?message=DeleteSuccess");
    } else {
        // Redirection en cas d'échec
        header("location:services-db-emp.php?message=DeleteFail");
    }
    ...
    header("location:services-db-emp.php?message=NoServiceID");
}
?>
