...
<?php
 ...
 <section class="home-description" id="description">
     <div class="description-about-elephant text-center text-white">
    <div class="description-about-content">
        <h1>ÉLÉPHANT DE SAVANE D’AFRIQUE</h1>
    </div>
</div>
     </section>
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        <div class="decrire">
        <h3>ÉLÉPHANT DE SAVANE D’AFRIQUE</h3>
        <p>L’éléphant de savane d’Afrique (Loxodonta africana), <br> aussi appelé éléphant de savane ou encore parfois éléphant d’Afrique, est un grand mammifère, <br>le plus gros animal terrestre. On le trouve dans divers déserts et savanes d’Afrique. <br>Mégaherbivore, il se nourrit de toute sorte de végétaux.
        </p>
    </div>
</div>
    <div class="row fram-space-before-medium fram-space-after-extra-large">
        <div class="col-lg-8">
   <img src="/savane/éléphant d'afrique.jpg"  style="width: 85%; height: 60%; margin-top: 30px;"alt=""  >
        </div>
<div class="col-lg-4">
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">L’éléphant d’Afrique se nourrit principalement d’herbes, de lianes, et d’autres plantes comme des racines et des graines. Pendant la saison sèche, il se nourrit également de feuilles, d’écorces et de fruits. </p>
                      </li>
                    
                    <li><i class="fa-solid fa-earth-africa" style="width: 48px; height: 48px;"></i>
                    <div class="text-wrap">
                    <h6 class="category">Habitat</h6> 
                        <p class="value">L’éléphant de savane d’Afrique vit principalement dans les savanes et prairies sèches ainsi que dans les déserts.</p>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">L'élephant est en bonne santé.</p>
