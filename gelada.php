...
<?php
 ...
 <section class="home-description" id="description">
     <div class="description-about-gelada text-center text-white">
...
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        <div class="decrire">
        <h3>GÉLADA</h3>
        <p>Le gélada (Theropithecus gelada), aussi appelé singe-lion, <br>est un grand singe que l’on trouve dans certains hauts plateaux herbus africains. <br> Végétarien, il se nourrit principalement d’herbe.</p>
    </div>
</div>
    <div class="row fram-space-before-medium fram-space-after-extra-large">
        <div class="col-lg-8">
   <img src="/images/jungle/mandrill.jpg"  style="width: 700px; height: 500px; margin-top: 30px;"alt=""  >
        </div>
<div class="col-lg-4">
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Le gélada se nourrit principalement de graminées, de jeunes pousses et de brins d’herbe qu’il arrache avec ses mains. Il mange aussi des fruits.
                        Si l’herbe vient à manquer, il se tourne vers des racines, des graines et des rhizomes. Il peut même parfois manger des petits insectes.</p>
                      </li>
                    
                    <li><i class="fa-solid fa-earth-africa" style="width: 48px; height: 48px;"></i>
                    <div class="text-wrap">
                    <h6 class="category">Habitat</h6> 
                        <p class="value">Le gélada vit essentiellement dans les hauts plateaux, dans les savanes et prairies tropicales sèches.</p>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Le gélada est en bonne santé.</p>
