...
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        ...
        <p> Le cerf de Virginie (Odocoileus virginianus), aussi appelé biche des palétuviers, <br> chevreuil de Virginie ou cariacou, est un grand cervidé que l’on trouve dans les <br>forêts, prairies, marais et déserts de certains pays Américains. <br> Principalement herbivore, il se nourrit de toute sorte de végétaux. </p>
    </div>
</div>
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Cerf de virginie est en bonne santé.</p>
