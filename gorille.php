...
<?php
 ...
 <section class="home-description" id="description">
     <div class="description-about-gorille text-center text-white">
...
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        <div class="decrire">
        <h3>GORILLE </h3>
        <p>Le gorille de l’Est (Gorilla beringei), plus souvent appelé gorille, <br>est un grand singe que l’on trouve dans quelques rares forêts tropicales humides d’Afrique. <br>Omnivore, il se nourrit principalement de fruits mais mange aussi certains insectes.</p>
    </div>
</div>
    <div class="row fram-space-before-medium fram-space-after-extra-large">
        <div class="col-lg-8">
   <img src="/images/jungle/gorille de l'est.jpg"  style="width: 700px; height: 500px; margin-top: 30px;"alt=""  >
        </div>
<div class="col-lg-4">
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Comme la plupart des autres grands singes, le gorille de l’Est se nourrit essentiellement de divers végétaux. Les gorilles des montagnes mangent cependant très peu de fruits (car peu présents sur leur aire de répartition) et se concentrent majoritairement sur les feuilles, les tiges et jeunes pousses. Les gorilles des plaines de l’Est mangent quant à eux des fruits en plus, ainsi que des fourmis. </p>
                      </li>
                    
                    <li><i class="fa-solid fa-earth-africa" style="width: 48px; height: 48px;"></i>
                    <div class="text-wrap">
                    <h6 class="category">Habitat</h6> 
                        <p class="value">Le gorille de l’Est vit essentiellement dans les forêts tropicales humides et les forêts de montagne.</p>
