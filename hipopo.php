...
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        <div class="decrire">
        <h3> HIPPOPOTAME</h3>
        <p>L’hippopotame commun (Hippopotamus amphibius), aussi appelé hippopotame amphibie ou même hippopotame, est un grand mammifère semi-aquatique que l’on trouve dans certains lacs et rivières en Afrique. Mégaherbivore, il se nourrit essentiellement d’herbes.</p>
    </div>
</div>
