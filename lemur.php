...
<?php
 ...
 <section class="home-description" id="description">
     <div class="description-about-lemur text-center text-white">
    <div class="description-about-content">
        <h1>MAKI LEMUR CATTA</h1>
    </div>
</div>
     </section>
<!-- end section home-->
 <section class="primary-bg">
    ...
    <div class="row details fram-space-before-medium" style="width: 100%;">
        <div class="decrire">
        <h3> MAKI LEMUR CATTA</h3>
        <p>Le maki catta (Lemur catta), aussi appelé lémur catta ou lémur à queue annelée, <br> est un lémurien arboricole que l’on trouve exclusivement dans les forêts tropicales de Madagascar. <br> Végétarien, il se nourrit de divers végétaux.</p>
    </div>
</div>
    <div class="row fram-space-before-medium fram-space-after-extra-large">
        <div class="col-lg-8">
   <img src="/images/jungle/lemurien.jpg"  style="width: 700px; height: 500px; margin-top: 30px;"alt=""  >
        </div>
<div class="col-lg-4">
            ...
            <div class="icon-list">
                <ul>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Le maki catta se nourrit essentiellement de fruits (gousses de tamarinier), de feuilles, mais aussi d’herbe, d’écorce, de fleurs et de sève.</p>
                    ...
                    <h6 class="category">Habitat</h6> 
                        <p class="value">Le maki catta vit exclusivement dans les forêts tropicales sèches et humides, ainsi que dans les fourrés arides de l’île.</p>
                    ...
                    <div class="text-wrap">
                        ...
                        <p class="value">Lemur est en bonne santé.</p>
