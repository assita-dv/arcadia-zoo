...
<!-- end section home tout les animaux-->

<!-- section groupe animaux  jungle, marais, savane-->
<section id="blogs">
    <div class="heaging-4">
     <div class="container">
     <div class="animaux-s">
...
<div class="row" style="margin-top: 65px;">
    ...
    <div class="card h-100" style="width: 18rem; ">
      ...
      <div class="card-body">
        <a href="tigre.php" ><button type="button" class="blogs-btn btn-lg">Tigre</button></a>
      </div>
  </div>
     </div>
  <div class="col ">
...
<div class="row" style="margin-top: 65px;">
  ...
  <div class="col ">
    ...
    <div class="card h-100" style="width: 18rem; ">
      ...
      <div class="card-body">
        <a href="gelada.php" ><button type="button" class="blogs-btn btn-lg">Gélada</button></a>
      </div>
  </div>
     </div>
  <div class="col ">
    <div class="card h-100" style="width: 18rem;">
      ...
      <div class="card-body">
        <a href="opaki.php" ><button type="button" class="blogs-btn btn-lg">Okapi</button></a>
      </div>
    </div>
  </div>
  <div class="col ">
  ...
  <div class="col ">
    <div class="card h-100" style="width: 18rem;" >
      ...
      <div class="card-body">
        <a href="gorille.php" ><button type="button" class="blogs-btn btn-lg">gorille</button></a>
      </div>
    </div>
  </div>
</div>
...
<div class="row" style="margin-top: 65px;">
  ...
  <div class="col ">
    <div class="card h-100" style="width: 18rem;">
      ...
      <div class="card-body">
        <a href="hipopo.php" ><button type="button" class="blogs-btn btn-lg">Hipopotame</button></a>
      </div>
    </div>
  </div>
     </div>
